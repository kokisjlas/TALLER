...
public class MenuTaller implements ActionListener {
	// ATRIBUTO VENTANA,CONTENEDOR Y MENUBAR OBLIGATORIOS PARA PODER MOSTRAR LAS
	// OPCIONES EN EL MENU GRAFICO
	...
	public MenuTaller(JFrame ventana) {
		...
		consultaVehiculoJMenuItem.addActionListener(this);

		modificacionVehiculoJMenuItem = new JMenuItem("Modificar Vehiculo");
		vehiculoJMenu.add(modificacionVehiculoJMenuItem);
		modificacionVehiculoJMenuItem.addActionListener(this);

		bajaVehiculoJMenuItem = new JMenuItem("Baja Vehiculo");
		vehiculoJMenu.add(bajaVehiculoJMenuItem);
		bajaVehiculoJMenuItem.addActionListener(this);
	}

	/*
	 * METODO QUE IMPLEMENTA ACTIONLISTENER ACA SE VE CUAL DE LAS OPCIONES DEL MENU
	 * SE HA ESCOGIDO Y SE EJECUTA
	 */
	@Override
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		if (e.getSource() == altaVehiculoJMenuItem) {
			// SE IMPRIME LA OPCION, SE AGREGA A LA VENTANA LLAMANDO A LA CLASE .VISTA DE LA
			// OPCION Y SE PONE VISIBLE
			...
			ventana.setContentPane(new ConsultaVehiculoVista());
			ventana.setVisible(true);
		} else if (e.getSource() == modificacionVehiculoJMenuItem) {
			System.out.println("Modificar Vehiculo");
			ventana.setContentPane(new ModificacionVehiculoVista());
			ventana.setVisible(true);
		} else if (e.getSource() == bajaVehiculoJMenuItem) {
			ventana.setContentPane(new BajaVehiculoVista());
			ventana.setVisible(true);
